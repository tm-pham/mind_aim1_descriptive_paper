...
df_inc_qrt_overall <- read.csv("data/mind_aim2-1_incidence_overall_by_org_quarterly.csv")
...
ggsave(figure1A, file = "figures/mind_aim2-1_figure1A.pdf", width=18, height=9.2)
...
# Save plot
ggsave(figure1B, file = "figures/mind_aim2-1_figure1B.pdf", width=16, height=10)

# ---------------------------------------------------------------------------- #
# FIGURE 1C
# ---------------------------------------------------------------------------- #
# Load incidence data by location of infection onset and by species
df_inc_qrt_onset <- read.csv("data/mind_aim2-1_incidence_by_onset_org_quarterly.csv")
